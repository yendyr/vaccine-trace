                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control @error('sales_coa_id') is-invalid @enderror" name="sales_coa_id" id="sales_coa_id">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control @error('inventory_coa_id') is-invalid @enderror" name="inventory_coa_id" id="inventory_coa_id">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control @error('cost_coa_id') is-invalid @enderror" name="cost_coa_id" id="cost_coa_id">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control @error('inventory_adjustment_coa_id') is-invalid @enderror" name="inventory_adjustment_coa_id" id="inventory_adjustment_coa_id">
