    ...
    $(document).ready(function () {
        ...
        var datatableObject = $(tableId).DataTable({
            ...
            columns: [
                ...
                { data: 'sales_coa.name', name: 'Sales COA', defaultContent: '<i>Inherits from Category</i>' },
                { data: 'inventory_coa.name', name: 'Inventory COA', defaultContent: '<i>Inherits from Category</i>' },
                { data: 'cost_coa.name', name: 'Cost COA', defaultContent: '<i>Inherits from Category</i>' },
                { data: 'inventory_adjustment_coa.name', name: 'Inventory Adjustment COA', defaultContent: '<i>Inherits from Category</i>' },
