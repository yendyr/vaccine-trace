...
namespace Modules\QualityAssurance\Policies;

use Illuminate\Auth\Access\HandlesAuthorization;
use Illuminate\Support\Facades\Auth;
use Modules\Gate\Entities\RoleMenu;

class TaskReleaseLevelPolicy
{
    ...
    public function viewAny()
    {
        ...
        )->where('menu_link', 'qualityassurance/task-release-level')->whereHas('role', function($role){
            $role->where('status', 1);
        })->first();
