...
class SkillLevelController extends Controller
{
    ...
    {
        return view('quality::pages.skill-level.index');
    }

    public function create()
    {
        return view('quality::pages.skill-level.form');
    }
    ...
    public function update(Request $request, SkillLevel $QualitySkillLevelAssurance)
    {
