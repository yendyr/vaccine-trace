        ...
        <div class="modal-content">
            ...
            <form method="post" id="inputForm">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-5 d-flex align-items-center">Task Release Level Name</label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-5 d-flex align-items-center">Sequence Level</label>
                        <div class="col-sm-7">
                            <input class="touchspin1 form-control" type="number" value="" name="sequence_level" id="sequence_level" max='5' min="1">                               
                            <div class="invalid-feedback-sequence_level text-danger font-italic"></div>
                        </div>
                    </div>    
                    <div class="form-group row">
                        <label class="col-sm-5 d-flex align-items-center">Authorized Engineering Level</label>
                        <div class="col-sm-7">
                            <select class="authorized_engineering_level form-control @error('authorized_engineering_level') is-invalid @enderror" id="authorized_engineering_level" name="authorized_engineering_level"></select>
                            <div class="invalid-feedback-authorized_engineering_level text-danger font-italic"></div>
                        </div>
                    </div>         
                    <div class="form-group row">
