                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-5 d-flex align-items-center">Supplier's Reference</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control @error('supplier_reference_document') is-invalid @enderror" name="supplier_reference_document" id="supplier_reference_document">
                                    <div class="invalid-feedback-supplier_reference_document text-danger font-italic"></div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="row m-b">
                                <div class="col">
                                    ...
                                    <textarea class="shipping_address" name="shipping_address" id="shipping_address">
                            ...
                            <div class="row m-b">
                                <div class="col">
                                    ...
                                    <textarea class="term_and_condition" name="term_and_condition" id="term_and_condition">
...
<script>
    $(document).ready(function(){
        $('.shipping_address').summernote({ height: 100 });
        $('.description').summernote({ height: 100 });
        $('.term_and_condition').summernote({ height: 100 });
    });
</script>
<script>
    ...
    var mem_valid_until_date = $('#valid_until_date .input-group.date').datepicker({
        format: 'yyyy-mm-dd',
        todayBtn: "linked",
        keyboardNavigation: false,
        forceParse: false,
