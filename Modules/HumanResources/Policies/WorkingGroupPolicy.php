...
class WorkingGroupPolicy
{
    ...
    /**
     * Determine whether the user can view any working-group.
     *
     * @param  \App\User  $user
     * @return mixed
     */
    public function viewAny()
    {
        ...
        )->where('menu_link', 'hr/working-group')->whereHas('role', function($role){
            $role->where('status', 1);
        })->first();
    ...
    /**
     * Determine whether the user can create working-group.
     *
     * @param  \App\User  $user
     * @return mixed
     */
     ...
     *
     * @param  \App\User  $user
     * @param  \App\Company  $working-group
     * @return mixed
     */
