...
class WorkingHourDetailController extends Controller
{
    use AuthorizesRequests;

    public function __construct()
    {
        $this->authorizeResource(WorkingHourDetail::class, 'working_hour_detail');
    ...
    {
        if ($request->ajax()) {
            $data = WorkingHourDetail::latest()->get();
