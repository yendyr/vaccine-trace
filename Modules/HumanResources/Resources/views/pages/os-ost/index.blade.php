...
{{--    @can('viewAny', \Modules\HumanResources\Entities\OrganizationStructureTitle::class)--}}
        @push('footer-scripts')
            ...
            <script type="text/javascript">
                ej.treegrid.TreeGrid.Inject(ej.treegrid.Edit, ej.treegrid.Toolbar, ej.treegrid.Sort, ej.treegrid.Filter, ej.data.WebApiAdaptor);
                {{--var data = new ej.data.DataManager({--}}
                {{--    url: '{{route("hr.os.index")}}',--}}
                ...
                var treeGridObj = new ej.treegrid.TreeGrid({
                    ...
                    editSettings: { allowEditing: true, allowAdding: true, allowDeleting: true, showDeleteConfirmDialog: true,
                        mode: 'Dialog', newRowPosition: 'Child', template:'#formModal' },
                    treeColumnIndex: 1,
                    columns: [
