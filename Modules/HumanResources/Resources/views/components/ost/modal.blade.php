        ...
        <div class="modal-content">
            ...
            <form method="post" id="ostForm">
                <div class="modal-body">
                    ...
                    <div class="form-group row"><label class="col-sm-2 col-form-label">Title Code</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row"><label class="col-sm-2 col-form-label">Job Title</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="fjobtitle" name="jobtitle">
                            <div class="invalid-feedback-jobtitle text-danger"></div>
                        </div>
                    </div>
                    <div class="form-group row"><label class="col-sm-2 col-form-label">Report Organization</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row"><label class="col-sm-2 col-form-label">Report Title</label>
                        <div class="col-sm-6">
