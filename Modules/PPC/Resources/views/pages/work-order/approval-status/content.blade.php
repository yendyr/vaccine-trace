<div class="row m-b fadeIn animate-md">
    <div class="col">
        <ol>
            <li>This work order and it's properties, won't shown up in any transaction (so you still can't use this aircraft) and reporting form until it approved</li>
            <li>Once this work order approved, any changes in this page won't be available any more</li>
...
<div class="row m-b fadeIn animate-md">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <p><strong>{{ $work_order->approvals->first()->creator->name ?? 'Not Yet Approved' }}</strong></p>
                        
                        <p class="m-b-none">Approved Date:</p>
                        <p><strong>{{ $work_order->approvals->first()->created_at ?? 'Not Yet Approved' }}</strong></p>
                    </div>
    ...
    @if($work_order->approvals()->count() == 0)
        @can('approval', $work_order)
            @component('components.approve-modal', ['name' => 'Work Order Datalist'])
            @endcomponent
