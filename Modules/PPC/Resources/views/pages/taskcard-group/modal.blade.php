        ...
        <div class="modal-content">
            ...
            <form method="post" id="inputForm">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-5 d-flex align-items-center">Task Card Group Name</label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <select class="select2_parent_name form-control @error('select2_parent_name') is-invalid @enderror" id="select2_parent_name" name="select2_parent_name"></select>
