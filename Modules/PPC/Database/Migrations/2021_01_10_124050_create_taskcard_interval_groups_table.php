...
class CreateTaskcardIntervalGroupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('taskcard_interval_groups', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('taskcard_interval_groups');
    }
}