...
$(document).ready(function () {
    ...
    var datatableObject = $(tableId).DataTable({
        ...
        searchDelay: 1500,
        ajax: {
            url: "/supplychain/mutation-outbound-detail/?id=" + $('#stock_mutation_id').val(),
        },
        columns: [
            ...
            { data: 'item_stock.highlighted', defaultContent: '-' },
            ...
            { data: 'item_stock.item_stock_initial_aging.initial_flight_hour', defaultContent: '-' },
            { data: 'item_stock.item_stock_initial_aging.initial_block_hour', defaultContent: '-' },
            { data: 'item_stock.item_stock_initial_aging.initial_flight_cycle', defaultContent: '-' },
            { data: 'item_stock.item_stock_initial_aging.initial_flight_event', defaultContent: '-' },
            { data: 'item_stock.item_stock_initial_aging.initial_start_date', defaultContent: '-' },
            { data: 'item_stock.item_stock_initial_aging.expired_date', defaultContent: '-' },
