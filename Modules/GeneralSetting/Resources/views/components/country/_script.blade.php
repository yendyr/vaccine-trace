    ...
    $(document).ready(function () {
        ...
        var datatableObject = $(tableId).DataTable({
            ...
            columns: [
                ...
                { data: 'iso3', name: 'ISO-3', defaultContent: '-' },
                { data: 'name', name: 'Name', defaultContent: '-' },
                { data: 'nicename', name: 'Nice Name', defaultContent: '-' },
                { data: 'numcode', name: 'Num. Code', defaultContent: '-' },
                { data: 'phonecode', name: 'Phone Code', defaultContent: '-' },
