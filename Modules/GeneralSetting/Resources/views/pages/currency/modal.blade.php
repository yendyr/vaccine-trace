        ...
        <div class="modal-content">
            ...
            <form method="post" id="inputForm">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-5 d-flex align-items-center">Symbol</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control @error('symbol') is-invalid @enderror" name="symbol" id="symbol">                            
                            <div class="invalid-feedback-symbol text-danger font-italic"></div>                            
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <select class="country_id form-control @error('country_id') is-invalid @enderror" id="country_id" name="country_id" required></select>
                            <div class="invalid-feedback-country_id text-danger font-italic"></div>
                            <div class="info-country_id text-info font-italic"></div>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    {{-- <div class="form-group row">
                        ...
                        <div class="col-sm-7">     
                            <div class="pretty p-icon p-round p-jelly p-bigger" style="font-size: 15pt;">   
                                <input type="checkbox" class="form-control @error('is_primary') is-invalid @enderror" name="is_primary" id="is_primary" />
                                <div class="state p-primary">
                                    <i class="icon fa fa-check"></i>
                                    <label></label>
                                </div>
