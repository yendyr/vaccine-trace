            ...
            <form method="post" id="inputForm">
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-md-3 d-flex align-items-center">Tanggal Vaksinasi</label>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select class="id_type form-control @error('id_type') is-invalid @enderror" name="id_type" id="id_type" required>
