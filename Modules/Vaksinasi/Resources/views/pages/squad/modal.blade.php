            ...
            <form method="post" id="inputForm">
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-sm-5 d-flex align-items-center">Kode Satuan</label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-5 d-flex align-items-center">Nama Satuan</label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-5 d-flex align-items-center">Deskripsi</label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-5 d-flex align-items-center">Target Vaksinasi</label>
                        <div class="col-sm-7">
                            <input type="number" min="1" class="form-control @error('vaccine_target') is-invalid @enderror" name="vaccine_target" id="vaccine_target" required>
                            <div class="invalid-feedback-vaccine_target text-danger font-italic"></div>
                        </div>
                    </div>
                    <div class="form-group row">
